		...
		<div class="main_video_block_rec" onclick ="gotoDetail(93)">
			<div class="main_video_thumb_rec">
				<a href="#">
					<div class="main_video_thumb_btn">
						<i class="far fa-heart fa-2x"></i>
					</div> <img src="resources/imges/dummy_lec_img/currier/currier_0.jpg"
					alt="lecfly lecture">
				</a>
			</div>
			<div class="main_video_info_lec">
				...
				<p class="main_video_info_title">"시선을 사로잡는 비즈니스 스피치. 스토리텔링
					프레젠테이션의 모든 것"</p>
				<img src="resources/imges/dummy_lec_img/currier/currier_0.jpg"
					class="video_info_creator_img">
		...
		<div class="main_video_block_rec">
			<div class="main_video_thumb_rec">
				<a href="#">
					<div class="main_video_thumb_btn">
						<i class="far fa-heart fa-2x"></i>
					</div> <img src="resources/imges/dummy_lec_img/art/art_1b.jpg"
					alt="lecfly lecture">
				</a>
			</div>
			<div class="main_video_info_lec">
				...
				<p class="main_video_info_title">"150년의 기간동안 이어온 전통. 그 가업을 물려받은
					장인의 격식 있고 깊이 있는 강의"</p>
				<img src="resources/imges/dummy_lec_img/art/art_2m.jpg"
					class="video_info_creator_img">

...
<link type="text/css" rel="stylesheet" href="resources/css/payment/pay_orderFinished.css">
<div id="paymentFinished_wrapper">
	<div id="paymentFinished_content">
		...
		<div id="finished_wrapper">
				...
				<div class="finished_backgroundInfo">
					<div class="finished_backgroundInfo2">
						<a href="javascript:void(0);" onclick="mainpage();" target="_self">
							...
							src="resource/img/logo/LecFly_LOGO_B_C.png" alt="LecFly">
					...
					<a class="finished_orderdelivery" href="javascript:void(0);"
						onclick="mypageDelivery();" target="_self"> 주문배송조회 </a>
				</div>
			</div>
			...
			<div class="deliveryGoods_set">
				...
				<div class="deliveryGoods_imgInfo">
					<a class="deliveryGoods_a" target="_self"
						href="javascript:void(0);" onclick="fundingItem();"> <strong>운동</strong><br>다이어트
						패키지 &lt홈트의 재정의&gt 다이어트 패키지
					</a>
			...
			<div class="deliveryGoods_set">
				<a class="deliveryGoods_img" target="_self"
					href="javascript:void(0);" onclick="fundingItem2();"> <img
					src="resource/img/payment/soap.jpg" width="85" height="85"
					alt="나를 위한 천연비누">
				</a>
				<div class="deliveryGoods_imgInfo">
					<a class="deliveryGoods_a" target="_self"
						href="javascript:void(0);" onclick="fundingItem2();"> <strong>라이프
							스타일</strong><br>LOVE YOUR LIFE 나를 위한 천연비누
					</a>
					<div class="deliveryGoods_cnt">구매수량 : 1 개</div>
					<div>
			...
			<div class="deliveryGoods_set">
				<a class="deliveryGoods_img" target="_self"
					href="javascript:void(0);" onclick="fundingItem2();"> <img
					src="resource/img/payment/cooking.jpg" width="85" height="85"
					alt="">
				</a>
				<div class="deliveryGoods_imgInfo">
					<a class="deliveryGoods_a" target="_self"
						href="javascript:void(0);" onclick="fundingItem2();"> <strong>쿠킹</strong><br>내
						상황에 딱 맞는 쿠킹 클래스
					</a>
					<div class="deliveryGoods_cnt">구매수량 : 1 개</div>
				...
				<table class="deliveryInfo_table">
					<tbody>
						...
						<tr>
							...
							<td class="deliveryInfo_table_td">경기도 부천시 원미로 144번길 51 101동
								1704호</td>
						</tr>
						<tr>

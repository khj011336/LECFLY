...
<body>
		...
		<div id="fundingPayment_wrapper">
						...
						<tbody>
							...
							<tr>
								...
								<td class="ordererInfo_table_td">
									<button type="button" name="phoneIdentity_button">인증
										완료</button>
								</td>
							</tr>
						</tbody>
					...
					<table class="deliveryPlaceInfo_table">
						<tbody>
							...
							<tr>
								<th class="deliveryPlaceInfo_table_th_nbsp">&nbsp;</th>
								<td colspan="3" class="deliveryPlaceInfo_table_td"><input
									type="text" id="fundingPayment_detailAddress"
									placeholder="상세주소"></td>
							</tr>
							<tr>
							<tr>
			...
			<div id="fundingPayment_order_button">
				<p class="fundingPayment_desc">위 주문 내용을 확인 하였으며, 회원 본인은 결제에
					동의합니다.</p>
				<a href="javascript:void(0)" onclick="selectOrderFinish()"
	...
	<script type="text/javascript">
    	...
    	// 결제 완료페이지로 이동
        function selectOrderFinish() {
			window.location.href = "${pageContext.request.contextPath}/pay_order_finish.LF";
		}
    </script>
</body>

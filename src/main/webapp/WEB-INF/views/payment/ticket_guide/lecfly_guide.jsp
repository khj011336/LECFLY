    ...
    <div class="CSsection">
        <div id="CSsec_title"><h2>홈페이지 안내</h2></div>
            <div id="CSsec_subtitle">
                <ul>
                    <li><h4><a href="lecfly_guide.LF" style="background-color: orange" class="lecfly_info">이용안내</a></h4></li>
                    <li><h4><a href="lecfly_ticket.LF" class="lecfly_membership_info">회원권</a></h4></li>
                </ul>
            </div>

<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="container1" style="height: 300px;">
        <div><img src="resources/imges/banner/ba_test1.jpg"><a href="goods_detail.LF?CFId=90" id="banner1">클래스 바로가기</a></div>
        <div><img src="resources/imges/banner/ba_test2.jpg"><a href="goods_detail.LF?CFId=90" id="banner1">클래스 바로가기</a></div>
        <div><img src="resources/imges/banner/ba_test3.jpg"><a href="goods_detail.LF?CFId=90" id="banner1">클래스 바로가기</a></div>
        <div><img src="resources/imges/banner/ba_test4.jpg"><a href="goods_detail.LF?CFId=90" id="banner1">클래스 바로가기</a></div>
        <div><img src="resources/imges/banner/ba_test5.jpg"><a href="goods_detail.LF?CFId=90" id="banner1">클래스 바로가기</a></div>
        <div><img src="resources/imges/banner/ba_test6.jpg"><a href="goods_detail.LF?CFId=90" id="banner1">클래스 바로가기</a></div>
        <div><img src="resources/imges/banner/ba_test7.jpg"><a href="goods_detail.LF?CFId=90" id="banner1">클래스 바로가기</a></div>
    </div>

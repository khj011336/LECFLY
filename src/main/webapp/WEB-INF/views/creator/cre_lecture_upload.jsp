      	...
      	<div id="cls_content">
       		...
       		<div id="cls_part2">
	    		<div class="cls_text1"><label for="cls_cover_img" class="creator_h3">클래스 커버이미지</label><span class="creator_h5 cls_left_interval">커버로 사용할 이미지를 추가해보세요</span></div>
       			<div id="cls_imgbox1" class="cls_imgbox1"><img src=" " class="cls_imgbox1">
       		...
       		<div id="cls_part3">
       			...
       			<div id="cls_imgbox2" class="cls_imgbox2"><img src="" class="cls_imgbox2">
       			<input  type="file"></div>
       			<div id="cls_imgbox3" class="cls_imgbox2"><img src="" class="cls_imgbox2">
       			<input  type="file"></div>

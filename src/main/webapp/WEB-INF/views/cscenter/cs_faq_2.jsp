...
<div class="CSsection">
	...
	<div id="faq">
           ...
           <ul>
               ...
               <li><a href="cs_faq_2.LF" style="background-color: orange" id="faq_2">강의수강</a></li>
           ...
           <div id="faq_main">
           		<div id="faq_table">
			    	...
			    	<ul>
			    		<c:forEach var="fq" items="${faq2}" varStatus="vs">
			    		<li>
			    			<div id ="faq_acodian">
			        ...
			        <div id="faq_numbering">
			        	<c:if test="${pn > 1}">
						<a href="${pageContext.request.contextPath}/cs_faq_2.LF?pn=${pn-1}">[PREV]</a>
					</c:if>
					 &nbsp; &nbsp;
					<c:forEach varStatus="vs" begin="1" end="${maxPn}" step="1">
						...
						<c:if test='${vs.current ne pn}'>
							<a href="${pageContext.request.contextPath}/cs_faq_2.LF?pn=${vs.current}"> ${vs.current}</a>
						</c:if>
						 &nbsp;
						 ${vs.current eq maxPn ? '': '|&nbsp;'}
					</c:forEach>
					 &nbsp; &nbsp;
					<c:if test="${pn < maxPn}">
						<a href="${pageContext.request.contextPath}/cs_faq_2.LF?pn=${pn+1}">[NEXT]</a>
					</c:if>

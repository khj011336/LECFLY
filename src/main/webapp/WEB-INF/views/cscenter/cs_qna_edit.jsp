	            ...
	            <tr>
	            	...
	            	<td>
		            	<div class="post_input_wrap">
		            		...
		            		<input type="text" class="input input_qna_name"  name="mbId" placeholder="이름" value="${mb.name}" readonly>
		            	</div>
	            	</td>
	            </tr>
	            <tr>
	            	...
	            	<td>
		            	<div class="post_input_wrap">
		            		<input type="text" class="input input_qna_id" name="mbNicname" placeholder="닉네임" value="${mb.nicname}" readonly>
		            	</div>
	            	</td>
	            </tr>
	            <tr>
	            	...
	            	<td>
		            	<div class="post_input_wrap">
		            		<input type="text" class="input input_qna_phone" placeholder="연락처" value="${mb.phNumber}" readonly>
		            	</div>
	            	</td>
	            </tr>
	            <tr>
	            	...
	            	<td>
		            	<div class="post_input_wrap">
		            		<input type="text" class="input input_qna_email" placeholder="이메일" value="${mb.email}" readonly>
		            	</div>
		            </td>
	            </tr>
	            <tr>

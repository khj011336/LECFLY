...
public class TestGeon {
	...
	final String SQL_SELECT_ALL_VIDEO_BY_CFID = "select * from video where CFID = ?";
	...
	final String SQL_SELECT_CRE_NAME_AND_CRE_INFO_BY_ID = 
			"select cre_user_name as name, cre_user_i_f as info from creator where id = ?";
